    ...
    <html lang="en">
        ...
        <body id="loginfondo">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Lista de canciones privadas</h1>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($canciones as $key => $value) {
                                                        $privado = ManejadorArchivos::obtenerPrivacidad($value);
                                                        $usu = ManejadorArchivos::obtenerUsuario($value);

                                                        if (substr($value, -4) == ".mp3" && $privado == "pr" && $usu == $sesion->getUser()) {
                                                            ?>
                                                            <tr>
                                                                <td>
                                                                    <?php echo ManejadorArchivos::obtenerTituloCancion($value, ".mp3") ?> 
                                                                </td>
                                                                <td>
                                                                    <?php
                                                                    echo "PRIVADA";
